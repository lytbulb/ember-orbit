...
import { PromiseObject } from './lib/promise-proxies';
...
var Model = Ember.Object.extend(Ember.Evented, {
  ...
  getLink: function(field) {
    ...
    var promise = store.findLinked(type, id, field)
      ...
      _this._assignLink(field, hasOneObject);

      return hasOneObject;
    });

    var promiseObject = PromiseObject.create({
      promise: promise
    });
  ...
  getLinks: function(field) {
    ...
    var relatedRecords = store.findLinked(type, id, field)
